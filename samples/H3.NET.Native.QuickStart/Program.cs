...
//
// This sample consumes the H3.NET.Native package via a PackageReference resolved from
// the local feed (see nuget.config). All angular values below are in DEGREES.

using H3.NET.Native;

Console.WriteLine("H3.NET.Native QuickStart");
Console.WriteLine("=======================");
Console.WriteLine();
...
Console.WriteLine("Done. Native libh3 was loaded from the H3.NET.Native package's runtimes/ assets.");
