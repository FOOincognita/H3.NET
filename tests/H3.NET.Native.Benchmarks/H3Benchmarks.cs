...
/// <summary>
/// Compares the native P/Invoke binding (H3.NET.Native) against the fully-managed
...
/// be verified offline at authoring time. The H3.NET.Native side is fully real.
